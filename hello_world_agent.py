...
async def main():
    async for message in query(
        prompt=(
            ...
            "1. Write a file called hello.html in C:/Users/ecc_p/Dev/hello_world_agent/ with a Hello World page "
            ...
            "start /B python -m http.server 8765 --directory C:/Users/ecc_p/Dev/hello_world_agent/\n"
